import IvanImg from '../assets/RetratoIvan.png'
import cv from '../assets/Mi cv.pdf'
...
export default function Inicio() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-30 flex flex-col items-center text-center py-4 px-6 animate-fade-up">
        ...
        <div className="w-[30vw] max-w-6xl aspect-video bg-card border border-border rounded-xl
       flex items-center justify-center mb-10">
          <img src={IvanImg} alt="Ivan Caballero" className="w-full h-full object-cover rounded-xl" />
        </div>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <a href={cv} target="_blank" className={`font-mono text-[11px] px-5 py-2.5

  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-30 flex flex-col items-center text-center px-6 animate-fade-up">
        <h1 className="font-pixel text-white mb-3 letterspacing-[0.1em]">
          Ivan Caballero
        </h1>

        <p className="font-pixel text-accent mb-10 letterspacing-[0.1em]">
          Game Developer
        </p>
       ...
       flex items-center justify-center mb-10">
        ...
        <div className="flex gap-3 justify-center">
          <a className={`font-mono text-[11px] px-5 py-2.5
